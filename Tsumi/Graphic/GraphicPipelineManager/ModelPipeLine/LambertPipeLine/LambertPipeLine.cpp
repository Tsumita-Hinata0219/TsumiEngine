...
// Psoを構築する
PsoProperty LambertPipeLine::SetUpPso()
{
	/* --- RootSignatureを作成 --- */
	...
	SetUpShader(vertexShaderBlob, pixelShaderBlob, ModelShaders::Lambert);
...
void LambertPipeLine::SetUpRootSignature(D3D12_ROOT_SIGNATURE_DESC& descriptionRootSignature)
{
	// 色に関する
