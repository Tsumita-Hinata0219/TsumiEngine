#include "HSVPipeLine.h"



// Psoを構築する
PsoProperty HSVPipeLine::SetUpPso()
{
	/* --- RootSignatureを作成 --- */
	...
	SetUpPostEffectShader(vertexShaderBlob, pixelShaderBlob, "HSV");
...
void HSVPipeLine::SetUpRootSignature(D3D12_ROOT_SIGNATURE_DESC& descriptionRootSignature)
{
