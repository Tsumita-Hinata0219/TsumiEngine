...
// Psoを構築する
PsoProperty LightPipeLine::SetUpPso()
{
	/* --- RootSignatureを作成 --- */
	...
	SetUpShader(vertexShaderBlob, pixelShaderBlob, ModelShaders::Light);
...
void LightPipeLine::SetUpRootSignature(D3D12_ROOT_SIGNATURE_DESC& descriptionRootSignature)
{
