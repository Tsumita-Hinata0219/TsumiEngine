#include "GrainPipeLine.h"



// Psoを構築する
PsoProperty GrainPipeLine::SetUpPso()
{
	/* --- RootSignatureを作成 --- */
	...
	SetUpPostEffectShader(vertexShaderBlob, pixelShaderBlob, "Grain");
...
void GrainPipeLine::SetUpRootSignature(D3D12_ROOT_SIGNATURE_DESC& descriptionRootSignature)
{
