...
// Psoを構築する
PsoProperty GrayScalePipeLine::SetUpPso()
{
	/* --- RootSignatureを作成 --- */
	...
	SetUpShader(vertexShaderBlob, pixelShaderBlob, PostEffectShaders::GrayScale);
...
void GrayScalePipeLine::SetUpRootSignature(D3D12_ROOT_SIGNATURE_DESC& descriptionRootSignature)
{
