...
void TestHuman::Update()
{
	...
	if (ImGui::TreeNode("TestHuman")) {
		...
		/*ImGui::DragFloat3("Scale", &humanWt_.srt.scale.x, 0.1f);
		ImGui::DragFloat3("Rotate", &humanWt_.srt.rotate.x, 0.1f);
		ImGui::DragFloat3("Translate", &humanWt_.srt.translate.x, 0.1f);*/
