...
public: // メンバ関数
	...
	/// </summary>
	static PhongNormalMap* GetInstance();
	...
	/// LightPSOの取得
	/// </summary>
	static PsoProperty GetPsoProperty() { return PhongNormalMap::GetInstance()->phongNormalMapPso_; }
...
private: // メンバ変数
	...
	PsoProperty phongNormalMapPso_{};
};
