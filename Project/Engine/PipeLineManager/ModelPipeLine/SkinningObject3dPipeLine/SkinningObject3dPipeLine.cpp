...
// Psoを構築する
PsoProperty SkinningObject3dPipeLine::SetUpPso()
{
	/* --- RootSignatureを作成 --- */
	...
	SetUpInputElementDescs(inputElementDescs[5], "WEIGHT", 0, DXGI_FORMAT_R32G32B32A32_FLOAT, D3D12D3D12_APPEND_ALIGNED_ELEMENT_APPEND_ALIGNED_ELEMENT);
