...
/// Sphere x Sphere
/// </summary>
inline bool Intersects(const SphereCollider& s1, const SphereCollider& s2) {
    // 中心からの距離
...
/// AABB x AABB
/// </summary>
inline bool Intersects(const AABBCollider& a1, const AABBCollider& a2) {
...
/// Sphere x AABB
/// </summary>
inline bool Intersects(const SphereCollider& s, const AABBCollider& a) {
    // 最近接点
...
inline bool Intersects(const AABBCollider& a, const SphereCollider& s) {
