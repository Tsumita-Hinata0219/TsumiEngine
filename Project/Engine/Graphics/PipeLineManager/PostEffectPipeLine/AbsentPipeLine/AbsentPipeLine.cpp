#include "AbsentPipeLine.h"



// Psoを構築する
PsoProperty AbsentPipeLine::SetUpPso()
{
	/* --- RootSignatureを作成 --- */
	...
	SetUpPostEffectShader(vertexShaderBlob, pixelShaderBlob, "Absent");
...
void AbsentPipeLine::SetUpRootSignature(D3D12_ROOT_SIGNATURE_DESC& descriptionRootSignature)
{
