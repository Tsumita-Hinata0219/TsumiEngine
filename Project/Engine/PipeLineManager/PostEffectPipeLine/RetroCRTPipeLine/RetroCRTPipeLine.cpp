#include "RetroCRTPipeLine.h"



// Psoを構築する
PsoProperty RetroCRTPipeLine::SetUpPso()
{
	/* --- RootSignatureを作成 --- */
	...
	SetUpPostEffectShader(vertexShaderBlob, pixelShaderBlob, "RetroCRT");
...
void RetroCRTPipeLine::SetUpRootSignature(D3D12_ROOT_SIGNATURE_DESC& descriptionRootSignature)
{
