...
// Psoを構築する
PsoProperty DissolvePipeLine::SetUpPso()
{
	/* --- RootSignatureを作成 --- */
	...
	SetUpPostEffectShader(vertexShaderBlob, pixelShaderBlob, ShaderManager::PostEffectShaders::Dissolve);
...
void DissolvePipeLine::SetUpRootSignature(D3D12_ROOT_SIGNATURE_DESC& descriptionRootSignature)
{
