#include "ConstantFieldPipeLine.h"



// Psoを構築する
PsoProperty ConstantFieldPipeLine::SetUpPso()
{
	/* --- RootSignatureを作成 --- */
	...
	IDxcBlob* shaderBlob =
		shaderManager->GetComputeShader("ConstantField").ComputeBlob; // shaderの取得
...
void ConstantFieldPipeLine::SetUpRootSignature(D3D12_ROOT_SIGNATURE_DESC& descriptionRootSignature)
{
