#include "GPUParticle_FadeOut_PipeLine.h"



// Psoを構築する
PsoProperty GPUParticle_FadeOut_PipeLine::SetUpPso()
{
	/* --- RootSignatureを作成 --- */
	...
	IDxcBlob* shaderBlob =
		shaderManager->GetComputeShader("GPUParticle_FadeOut").ComputeBlob; // shaderの取得
...
void GPUParticle_FadeOut_PipeLine::SetUpRootSignature(D3D12_ROOT_SIGNATURE_DESC& descriptionRootSignature)
{
